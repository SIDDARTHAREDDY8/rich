...
- Fixed `Console.export_svg()` generating a dangling `clip-path` reference for the last line by emitting a `<clipPath>` definition for every emitted line https://github.com/Textualize/rich/issues/4215
